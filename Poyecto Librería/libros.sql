...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2016 a las 04:59:16
...
--
-- Estructura de tabla para la tabla `libreria_has_libros`
--
...
--
-- Volcado de datos para la tabla `libreria_has_libros`
--
...
--
-- Estructura de tabla para la tabla `libros_has_generos`
--
...
--
-- Volcado de datos para la tabla `libros_has_generos`
--
...
--
-- Indices de la tabla `libreria_has_libros`
--
...
--
-- Indices de la tabla `libros_has_generos`
--
...
--
-- Filtros para la tabla `libreria_has_libros`
--
ALTER TABLE `libreria_has_libros`
...
--
-- Filtros para la tabla `libros_has_generos`
--
ALTER TABLE `libros_has_generos`
